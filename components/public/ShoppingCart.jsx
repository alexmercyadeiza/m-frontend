                ...
                <div className="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                  <div className="flex-1 py-6 overflow-y-auto px-4 sm:px-6">
                    <div className="flex items-start justify-between">
                      <Dialog.Title className="text-sm font-medium uppercase tracking-widest">
                        Shopping cart
                      </Dialog.Title>
                  ...
                  <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                    ...
                    <div className="mt-6">
                      <div
                        ...
                        className="cursor-pointer uppercase flex justify-center items-center px-6 py-3 border border-transparent shadow-sm text-base font-medium text-white bg-yellow-600 hover:bg-yellow-700"
                      >
                        Checkout
                      </div>
                    </div>
