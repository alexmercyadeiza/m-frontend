...
export default function ShoppingCart() {
  ...
  const removeProduct = (_id, price) => {
    ...
    updateSharedState({
      ...sharedState,
      cartItems,
      cartTotalPrice: sharedState.cartTotalPrice - price,
    });
  };

  // const sumTotal = () => {
  //   const t = sharedState.cartItems.map((item) => setTotal(total + item.price));
  //   return t;
  // };
                ...
                <div className="h-full flex flex-col bg-white shadow-xl overflow-y-scroll">
                  ...
                  <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                    <div className="flex tracking-tight justify-between text-base font-medium text-gray-900">
                      <p>Subtotal</p>
                      <p className="font-mono">${sharedState.cartTotalPrice}</p>
                    </div>
                    <p className="mt-0.5 tracking-tight text-sm text-gray-500">
                      Shipping will be calculated at checkout.
                    </p>
                    <div className="mt-6">
                      <div className="cursor-pointer flex justify-center items-center px-6 py-3 border border-transparent tracking-tight shadow-sm text-base font-medium text-white bg-yellow-600 hover:bg-yellow-700">
                        Checkout
                      </div>
                    </div>
